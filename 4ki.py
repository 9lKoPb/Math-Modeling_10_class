...
t = np.arange(10**(-7), 1.5*10**(-7),10**(-10))
...
x20 = 0.008
vx20 = -(np.sin(np.pi/4)*a)
y20 = 0.008  
vy20 = (np.sin(np.pi/4)*a)
    
x30 = -0.008
vx30 = (np.sin(np.pi/4)*a)
y30 = -0.008
vy30 = -(np.sin(np.pi/4)*a)

x40 = 0.008
vx40 = (np.sin(np.pi/4)*a)
y40 = -0.008
vy40 = (np.sin(np.pi/4)*a)
